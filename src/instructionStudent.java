...
public String rollNo;
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("   During the Exam:\n\n1. The student may not use his or her textbook, notes, or receive any help from \n    proctor or any other outside source.\n\n2. Students must complete the 10 Multiple Choice Question Exam within 10-Minutes time\n    frame allotted for the exam.\n\n3. Students must not stop the session and then return to it. This is especially \n   important in the Online Environment where the System will \"time-out\" and not allowed\n   the student to re-enter the exam.\n\n    Number of Questions: 10\n    Exam Duration: 10 min\n    All The Best!! ");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 105, 1346, 549));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 686, -1, -1));
